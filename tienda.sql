...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-07-2023 a las 15:08:56
...
INSERT INTO `articulos` (`articulo_id`, `nombre`, `precio`, `stock_actual`, `stock_minimo`, `rubro_id`) VALUES
(1, 'Televisor', '599.99', 10, 5, 1),
(2, 'Cámara', '199.99', 8, 3, 1),
(3, 'Camiseta', '19.99', 50, 10, 2),
(4, 'Pantalón', '39.99', 30, 5, 2),
(5, 'Sartén', '29.99', 20, 5, 3),
(6, 'Olla', '39.99', 15, 3, 3),
(7, 'Pelota', '9.99', 100, 20, 4),
(8, 'Raqueta', '49.99', 25, 5, 4),
(9, 'Muñeca', '14.99', 50, 10, 5),
(10, 'Bloques', '24.99', 40, 8, 5),
(11, 'Laptop', '899.99', 15, 5, 1),
(12, 'Smartphone', '599.99', 20, 5, 1),
(13, 'Tablet', '299.99', 12, 3, 1),
(14, 'Impresora', '149.99', 8, 2, 1),
(15, 'Mouse', '19.99', 50, 10, 1),
(16, 'Teclado', '39.99', 30, 5, 1),
(17, 'Monitor', '249.99', 15, 5, 1),
(18, 'Altavoces', '79.99', 20, 5, 1),
(19, 'Cámara DSLR', '699.99', 5, 2, 1),
(20, 'Auriculares', '99.99', 25, 5, 1),
(21, 'Camiseta deportiva', '29.99', 50, 10, 2),
(22, 'Pantalón deportivo', '39.99', 30, 5, 2),
(23, 'Zapatillas', '79.99', 20, 5, 2),
(24, 'Gorro', '9.99', 40, 8, 2),
(25, 'Chaqueta', '59.99', 15, 3, 2),
(26, 'Manta', '49.99', 20, 5, 3),
(27, 'Cortinas', '39.99', 15, 3, 3),
(28, 'Silla', '79.99', 10, 2, 3),
(29, 'Mesa de centro', '129.99', 8, 2, 3),
(30, 'Cubiertos', '19.99', 100, 20, 3),
(31, 'Balón de fútbol', '14.99', 30, 5, 4),
(32, 'Raqueta de tenis', '79.99', 25, 5, 4),
(33, 'Pelota de béisbol', '9.99', 50, 10, 4),
(34, 'Gafas de natación', '24.99', 40, 8, 4),
(35, 'Bicicleta', '299.99', 10, 2, 4),
(36, 'Muñeca de peluche', '19.99', 50, 10, 5),
(37, 'Juego de construcción', '29.99', 40, 8, 5),
(38, 'Rompecabezas', '14.99', 30, 6, 5),
(39, 'Carro de juguete', '9.99', 60, 12, 5),
(40, 'Libro de cuentos', '12.99', 80, 15, 5),
(41, 'Vaso de vidrio', '4.99', 100, 20, 3),
(42, 'Caja de herramientas', '49.99', 15, 3, 3),
(43, 'Guitarra acústica', '199.99', 5, 2, 1),
(44, 'Pelota de baloncesto', '19.99', 30, 6, 4),
(45, 'Patineta', '59.99', 20, 5, 4),
(46, 'Platos de cerámica', '9.99', 80, 15, 3),
(47, 'Toallas de baño', '14.99', 60, 12, 3),
(48, 'Figuras de acción', '24.99', 40, 8, 5),
(49, 'Vestido', '49.99', 20, 5, 2),
(50, 'Reloj de pulsera', '99.99', 25, 5, 1),
(51, 'Botas de invierno', '89.99', 15, 3, 2),
(52, 'Cepillo de dientes', '4.99', 100, 20, 3),
(53, 'Lámpara de escritorio', '29.99', 30, 6, 3),
(54, 'Almohada', '19.99', 40, 8, 2);
...
INSERT INTO `localidades` (`localidad_id`, `provincia_id`, `localidad`) VALUES
(1, 1, '25 de Mayo'),
(2, 1, '3 de febrero'),
(3, 1, 'A. Alsina'),
...
INSERT INTO `rubros` (`rubro_id`, `nombre`) VALUES
(1, 'Electrónica'),
(2, 'Ropa'),
(3, 'Hogar'),
(4, 'Deportes'),
...
INSERT INTO `usuarios` (`usuario_id`, `usuario`, `password`, `estado`, `ult_login`, `rol_id`) VALUES
(1, 'admin', 'admin', 1, '2023-07-07 10:51:21', 1),
(2, 'usuario', 'usuario', 1, '2023-07-07 10:42:27', 2),
(3, 'inactivo', 'inactivo', 2, NULL, 2);
...
--
ALTER TABLE `articulos`
  MODIFY `articulo_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;

--
-- AUTO_INCREMENT de la tabla `localidades`
--
ALTER TABLE `localidades`
  MODIFY `localidad_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2383;
...
--
ALTER TABLE `provincias`
  MODIFY `provincia_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `rubros`
  MODIFY `rubro_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `articulos`
  ADD CONSTRAINT `articulos_ibfk_1` FOREIGN KEY (`rubro_id`) REFERENCES `rubros` (`rubro_id`);
...
--
ALTER TABLE `pedidos_items`
  ADD CONSTRAINT `pedidos_items_ibfk_1` FOREIGN KEY (`pedido_id`) REFERENCES `pedidos` (`pedido_id`),
  ADD CONSTRAINT `pedidos_items_ibfk_2` FOREIGN KEY (`articulo_id`) REFERENCES `articulos` (`articulo_id`);
COMMIT;
